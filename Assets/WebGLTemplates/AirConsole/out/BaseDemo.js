...
var BaseDemo = /** @class */ (function (_super) {
    ...
    function BaseDemo() {
        ...
        _this._renderer = new PIXI.Renderer(400, 320);
    ...
    BaseDemo.prototype._loadResources = function () {
        var _this = this;
        var binaryOptions = { loadType: PIXI.LoaderResource.LOAD_TYPE.XHR, xhrType: PIXI.LoaderResource.XHR_RESPONSE_TYPE.BUFFER };
        for (var _i = 0, _a = this._resources; _i < _a.length; _i++) {
            ...
            if (resource.indexOf("dbbin") > 0) {
                ...
                PIXI.Loader.shared.add(resource, resource);
            }
        }
        PIXI.Loader.shared.once("complete", function (loader, resources) {
    ...
    BaseDemo.prototype.createText = function (string) {
        ...
        text.y = this.stageHeight * 0.5 - 50.0;
        this.addChild(text);
        return text;
    };
