...
public class ConstantsBucket : Singleton<ConstantsBucket> {
    ...
    [SerializeField] float smashFlyDistance = 3f;
    public static float SmashFlyDistance { get { return Instance.smashFlyDistance; } }
    ...
    [SerializeField] public bool useAnimFrameSkipping = false;
    public static bool UseAnimFrameSkipping {
        get {
            return Instance.useAnimFrameSkipping;
        }
    }
